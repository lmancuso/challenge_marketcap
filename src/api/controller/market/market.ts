...
import { TPairBook } from "../../../store/book.type";

import ICalculate from "../../service/market/calculations.type";

import { calcBuy, calcSell } from "../../service/market/calculations";
...
const calcExecution = (req: Request, res: Response, next: NextFunction) => {
  try {
    ...
    logger.info(
      `API: Request to simulate execution - market prices pair:${pair} operation:${operation}...`
    );
